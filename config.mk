...
# A large population of paths at or above the target period is an early
# convergence warning even when the individual path-depth gate is unchanged.
RTL_QC_MAX_OVER_TARGET_PATHS_200 ?= 100
...
RTL_QC_MAX_OVER_TARGET_PATHS_250 ?= 100
...
RTL_QC_MAX_OVER_TARGET_PATHS ?= $(RTL_QC_MAX_OVER_TARGET_PATHS_$(RTL_QC_FREQ_MHZ))
