...
//
// The Xilinx implementation explicitly selects distributed RAM.  The
// non-Xilinx branch is a simulation/synthesis-friendly model with the same
// interface, so the module can be linted without XPM libraries.
