	...
	always_ff @(posedge clk) begin
        if($time >= sv_timeout) begin
            ...
            $display("[TB] id_ctrl rs1=%0d ren1=%0b pend1=%0b rs2=%0d ren2=%0b pend2=%0b rd=%0d wen=%0b pend_rd=%0b lsu_req=%0b lsu_busy=%0b",
                     u_dut.rf_ctrl_rs1_addr,
                     u_dut.rf_ctrl_rs1_ren,
                     u_dut.gpr_pending_for_hazard[u_dut.rf_ctrl_rs1_addr],
                     u_dut.rf_ctrl_rs2_addr,
                     u_dut.rf_ctrl_rs2_ren,
                     u_dut.gpr_pending_for_hazard[u_dut.rf_ctrl_rs2_addr],
                     u_dut.rf_ctrl_rd_addr,
                     u_dut.rf_ctrl_rd_wen,
                     u_dut.gpr_pending_for_hazard[u_dut.rf_ctrl_rd_addr],
                     u_dut.rf_ctrl_lsu_req,
                     u_dut.lsu_ctrl_busy);
