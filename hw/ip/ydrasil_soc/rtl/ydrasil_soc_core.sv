...
(
    ...
    ydrasil_mmio_subsystem #(
        ...
        .spi_miso_i(spi_miso_i), .spi_sclk_o(spi_sclk_o),
        .spi_mosi_o(spi_mosi_o), .spi_cs_n_o(spi_cs_n_o),
    ...
    ydrasil_coremark_monitor u_coremark_monitor (
        ...
        .auto_enable_async_i(coremark_auto_enable),
        .pc_base_async_i(coremark_pc_base),
        .pc_limit_async_i(coremark_pc_limit),
        .timeout_async_i(coremark_timeout),
        .retire0_valid_i(retire0_valid), .retire0_pc_i(retire0_pc),
        .retire1_valid_i(retire1_valid), .retire1_pc_i(retire1_pc),
